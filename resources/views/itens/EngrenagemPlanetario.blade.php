        ...
        <div class="col-lg-12 col-md-12" style="padding:0px">
            <div class="panel-heading text-center">
                <div class="col-md-12 text-center m-b-30">
                    <h2 class='title m-b-40'>Engrenagem Interna (Reto / Helicoidal) - (Planetário)</h2> 
                    <div class="col-lg-12" style="text-align:left">
                        <img class="float-r" src="{{ asset('img/plus.png') }}"  data-toggle="collapse" href="#adicionarEngrenagem" role="button" style="width:32px">
                        ...
                        <div class="collapse " id="multiCollapseExample1">
                            <div class="col-lg-4 col-md-4 col-sm-4">                          
                                <div class="list-group">
                                    ...
                                    <a href="{{ route('index.ParCilindricoPinhao', $peritagem->ID_Peritagem) }}" class="list-group-item list-group-item-action">Par Cilindrico Pinhão</a>
            ...
            <div id="adicionarEngrenagem" class="col-lg-12 col-md-12 col-sm-12 col-12 m-t-10 collapse">
                <div class="panel panel-default">  
                    <form action="{{ route('adicionar.itens', $peritagem->ID_Peritagem) }}" method='POST'>
                        ...
                        <div class="panel-heading text-center" style="background-color: #465686;color: white;">
                            <label>Engrenagem Interna (Reto / Helicoidal) - (Planetário)</label>
                        </div>
                        <div class="panel-body"> 
                            <input type="hidden" name="ID_TipoItem" value='3'>
                            <input type="hidden" value='index.EngrenagemInterna' name='rota'>
                            <div class="col-lg-12">
            ...
            <table class="table">
                    ...
                    @foreach($registro as $array)
                        <tr>
                            ...
                            <td><img src="{{ asset('img/search.png') }}" width="30" data-toggle="modal" data-target="#verPeritagem"></td>
                        </tr>       
                        <!-- Modal -->
                        <div class="modal fade" id="verPeritagem" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
