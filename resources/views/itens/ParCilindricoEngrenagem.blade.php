        ...
        <div class="col-lg-12 col-md-12" style="padding:0px">
            <div class="panel-heading text-center">
                <div class="col-md-12 text-center m-b-30">
                    <h2 class='title m-b-40'>Par Cilindrico (Reto / Helicoidal ) - Engrenagem</h2> 
            ...
            <div id="adicionarEngrenagem" class="col-lg-12 col-md-12 m-t-10 collapse">
                <div class="panel panel-default">  
                    <form action="{{ route('adicionar.itens', $peritagem->ID_Peritagem) }}" method='POST'>
                        ...
                        <div class="panel-heading text-center" style="background-color: #465686;color: white;">
                            <label>Par Cilindrico (Reto / Helicoidal) - (Engrenagem)</label>
                        </div>
                        <div class="panel-body"> 
                            <input type="hidden" value='2' name='ID_TipoItem'>
                            <input type="hidden" value='index.ParCilindricoEngrenagem' name='rota'>
                            <div class="col-lg-12">
